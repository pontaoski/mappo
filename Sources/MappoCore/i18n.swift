...
struct English: I18n {
	...
	let winterWolfAction = "Looks like it's winter! With your snow coat, it's time to freeze someone tonight! This will prevent them from performing any action today."
	let normalWolfAction = "Time to kill someone tonight!"
	let gaAction = "Time to protect someone tonight!"
	let seerAction = "Time to see someone tonight!"
	let cpAction = "Time to visit someone tonight!"
	let gooseAction = "Time to goose someone tonight!"
	let gaPrompt = "Choose someone to protect"
	let seerPrompt = "Choose someone to see their role"
	let cpPrompt = "Choose someone to visit during the night and give them cookies"
	let goosePrompt = "Choose someone to goose tonight!"
	let drWerewolf = "You were killed by a werewolf!"
	let drExile = "You were exiled by the village!"
	let drVisit = "You died because you visited a werewolf!"
	let drProtect = "You died because you protected a werewolf!"
	let drInnocent = "You died because you were the first person to nominate an Innocent!"
	let drGoose = "A goose killed you!"
